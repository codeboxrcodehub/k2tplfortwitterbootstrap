...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm" class="form-horizontal well">
	<?php if($this->mainframe->isSite()): ?>
	<div id="k2FrontendContainer" class="cbx-k2FrontendContainer-item">
		<div id="k2Frontend">
            <div class="k2FrontendToolbar">
                <div class="control-group">
                    <div class="control-label cbx-label">
                        <div id="toolbar-save" class="button">
                            <a class="toolbar btn btn-success" href="#" onclick="Joomla.submitbutton('save'); return false;"> <span title="<?php echo JText::_('K2_SAVE'); ?>" class="icon-32-save icon-save"></span> <?php echo JText::_('K2_SAVE'); ?> </a>
                        </div>
                    </div>
                    <div class="controls">
                        <div id="toolbar-cancel" class="button">
                            <a class="toolbar btn btn-warning cbx-warning" href="#"> <span title="<?php echo JText::_('K2_CANCEL'); ?>" class="icon-32-cancel icon-cancel"></span> <?php echo JText::_('K2_CLOSE'); ?> </a>
                        </div>
                    </div>
                </div><!--//control-group-->
            </div><!--//.k2FrontendToolbar-->
            ...
            <div class="adminFormK2Container">
                <fieldset class="cbx-padding10">

                    <div class="control-group">
                        <div class="adminK2LeftCol control-label">
                            <label for="title"><?php echo JText::_('K2_TITLE'); ?></label>
                        </div>
                        <div class="adminK2LeftCol controls">
                    ...
                    <?php if($this->mainframe->isAdmin() || ($this->mainframe->isSite() && $this->permissions->get('publish')  || ($this->permissions->get('editPublished') && $this->row->id && $this->row->published)  )): ?>
                        <?php if($this->permissions->get('publish')): ?>
                            ...
                            <div class="control-group cbx-padding10">
                                <div class="adminK2LeftCol control-label ">
                                    <label for="featured"><?php echo JText::_('K2_IS_IT_FEATURED'); ?></label>
                                </div>
                                <div class="adminK2LeftCol cbxk2-yesno ">
            ...
            </div><!--//.adminFormK2Container table-->



            <table cellspacing="0" cellpadding="0" border="0" class="adminFormK2Container cbk2-contenttab x table ">
				<tbody>
					<tr>
						<td>
                        <!-- Tabs start here -->
