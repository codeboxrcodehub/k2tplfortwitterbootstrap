    ...
    <?php if($this->item->params->get('itemTitle')): ?>
        ...
        <h2 class="itemTitle">
            <?php if(isset($this->item->editLink)): ?>
				...
				<a class="btn btn-success k2editmodalfix"   rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
...
<?php if(
    ...
    <div class="btn-group pull-right cbxl2-print">
        ...
        <ul class="dropdown-menu">
            <?php if($this->item->params->get('itemFontResizer')): ?>
                <!-- Font Resizer -->
                <li>
                    <span class="itemTextResizerTitle"><i class="fa fa-font"></i> <?php echo JText::_('K2_FONT_SIZE'); ?></span>
                    <a href="#" id="fontDecrease" class="cbxk2-fontresize">
                        <span><i class="fa fa-minus"></i> <?php echo JText::_('K2_DECREASE_FONT_SIZE'); ?></span>
                        <img src="<?php echo JURI::root(true); ?>/components/com_k2/images/system/blank.gif" alt="<?php echo JText::_('K2_DECREASE_FONT_SIZE'); ?>" />
                    </a>
                    <a href="#" id="fontIncrease" class="cbxk2-fontresize">
                         <span><i class="fa fa-plus"></i> <?php echo JText::_('K2_INCREASE_FONT_SIZE'); ?></span>
            ...
            <?php if($this->item->params->get('itemPrintButton') && !JRequest::getInt('print')): ?>
                ...
                <li>
                    <a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
                        <i class="fa fa-print"></i> <span><?php echo JText::_('K2_PRINT'); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <?php if($this->item->params->get('itemEmailButton') && !JRequest::getInt('print')): ?>
                ...
                <li>
                    <a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
                        <i class="fa fa-envelope"></i> <span><i class="fa fa-mail"></i> <?php echo JText::_('K2_EMAIL'); ?></span>
                    </a>
                </li>
            <?php endif; ?>
    ...
    <div class="itemLinks">
        ...
        <?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
            ...
            <div class="itemTagsBlock">
                ...
                <ul class="itemTags cbx-k2tag">
                    <?php foreach ($this->item->tags as $tag): ?>
                        <li>
                            <span class="label label-primary"><a href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></span>
                        </li>
                    <?php endforeach; ?>
                </ul>
                <div class="clr"></div>
    ...
    <div class="itemAuthorBlock">
        ...
        <div class="itemAuthorDetails">
            <h3 class="itemAuthorName">
                <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php if( isset( $this->item->author->name ) ) { echo $this->item->author->name;}?></a>
            </h3>
...
<?php if($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
    ...
    <div class="itemAuthorLatest">
        <h3><?php echo JText::_('K2_LATEST_FROM'); ?> <?php  ?></h3>
        <ul>
...
<?php if(!JRequest::getCmd('print')): ?>
    <div class="itemBackToTop">
        <a class="k2Anchor" href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>">
            <?php //echo JText::_('K2_BACK_TO_TOP'); ?><i class="fa fa-arrow-circle-up"></i>
        </a>
    </div>
<?php endif; ?>
