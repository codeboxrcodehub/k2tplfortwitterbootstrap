...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate form-horizontal well">
    ...
    <div class="form-group">
    <input type="submit" class="button btn btn-default " id="submitCommentButton" value="<?php echo JText::_('K2_SUBMIT_COMMENT'); ?>" />
    </div>
